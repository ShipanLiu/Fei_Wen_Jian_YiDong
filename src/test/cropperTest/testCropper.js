...
class CustomCrop extends Component {
  ...
  crop() {
    ...
    return coordinates;
    console.log('cropped');
    // RNOpencv3.crop(coordinates, this.state.image, (err, res) =>
      ...
      <View
        ...
        <View
          ...
          <Animated.View
            ...
            <View style={[s(this.props).handlerI, {left: -10, top: 10}]} />
            <View
              style={[s(this.props).handlerRound, {left: 31, bottom: 31}]}
            />
          </Animated.View>
          <Animated.View
            ...
            <View style={[s(this.props).handlerI, {left: 10, top: 10}]} />
            <View
              style={[s(this.props).handlerRound, {right: 31, bottom: 31}]}
            />
          </Animated.View>
        </View>
      </View>
