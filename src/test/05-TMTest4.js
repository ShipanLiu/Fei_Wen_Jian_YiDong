/*
  expo camera + album + tensorflow prediction
https://github.com/GoGiants1/react-native-tfjs/blob/main/src/Home.js

ideo: how to read local image and convert to base64.
*/
...
export default function Home() {
  ...
  return (
    <View style={tailwind(`flex flex-1 ${bgColor}`)}>
      ...
      <View
        style={tailwind(
          'flex flex-row items-center justify-between px-4 pt-2',
        )}>
        {!menuShown ? (
          <TouchableOpacity
            activeOpacity={0.7}
